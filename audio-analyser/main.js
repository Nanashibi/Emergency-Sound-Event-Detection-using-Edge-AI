...
// Setup MQTT
const client = mqtt.connect('mqtts://2d467655eed049ffbb040e09aaac42ef.s1.eu.hivemq.cloud', {
  username: "shreya", // Your MQTT server username here
  password: "Shreya123" // Your MQTT password here
})
